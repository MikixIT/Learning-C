...
This repo exists to help me learn C in the most fun, chaotic and visual way possible.

```text
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃  ↓      entering low-level experiment zone       ↓  ┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
┌───────────────────── ritual.sh ──────────────────────┐
│ $ gcc main.c -o main                                  │
│ main.c:42: warning: learning intensifies              │
│                                                       │
│ $ ./main                                              │
│ >> status: curiosity rising                           │
│ >> memory: may or may not explode                     │
└───────────────────────────────────────────────────────┘
```
...
```text
┌───────────── MEMORY MAP ─────────────┐
│ 0x0000  | area sicura (forse)        │
│ 0x0040  | variabili sperimentali     │
│ 0x00A0  | puntatore sospetto          │
│ 0x00FF  | free() dimenticato          │
│ 0x0BAD  | undefined behavior zone     │
└──────────────────────────────────────┘
```
...
```text
              /\    
    all hail /  \   the compiler
           / ⚙️  \   
          /______\  
     may your warnings be kind  
